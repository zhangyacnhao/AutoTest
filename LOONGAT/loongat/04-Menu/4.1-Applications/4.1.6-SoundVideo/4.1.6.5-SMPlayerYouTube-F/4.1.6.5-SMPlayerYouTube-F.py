...
#########################################################################
#全局变量区域
g_tag ="4.1.6.5-SMPlayerYouTube-F"
mylog = Logcase()
Sshot = Screenshot()
winName = "未命名 - SMPlayerYouTube-F"
global passwd
def chkdir(dir):
	try:
...
def work():
	...
	sleep(6)
	Sshot.scrprint(g_tag, 'After_SMPlayerYouTube', './')
	sleep(4)
	print 'will be close the window'
	kcmd = "kill -9 %d" % pid
	kcmdFirefox = "pkill firefox"
	os.system(kcmd)
	os.system(kcmdFirefox)
