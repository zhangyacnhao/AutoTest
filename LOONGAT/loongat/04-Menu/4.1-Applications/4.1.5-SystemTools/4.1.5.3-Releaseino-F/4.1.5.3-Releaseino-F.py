...
#########################################################################
#全局变量区域
g_tag ="4.1.5.3-Releaseino-F"
mylog = Logcase()
Sshot = Screenshot()
winName = "未命名 - Releaseino-F"
global passwd
def chkdir(dir):
	try:
		...
		return True
def work():
	launchapp('firefox',['file:///usr/share/doc/fedora-release-notes/en-US/index.html'])
	...
	sleep(11)
	Sshot.scrprint(g_tag, 'After_Releaseino', './')
	sleep(4)
